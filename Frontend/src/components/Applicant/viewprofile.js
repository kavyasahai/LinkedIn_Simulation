...
class Homepage extends Component
{
    ...
    render()
    {
      ...
      let experiencedata=this.state.userdata.experience && this.state.userdata.experience.map(userdetail=>{ 
      ...
      let education=this.state.userdata.education && this.state.userdata.education.map(userdetail=>{ 
...
<h3>Summary</h3>
    <div>
    {this.state.userdata ? this.state.userdata.profileSummary:""}
    </div>
    </section>
    <section class="pv-profile-section pv-top-card-section artdeco-container-card ember-view">
<h3>Skills</h3>
