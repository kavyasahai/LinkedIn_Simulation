...
class Homepage extends Component
{
    ...
    render()
    {
      ...
      let experiencedata=this.state.userdata[0] && this.state.userdata[0].experience.map(userdetail=>{ 
      
      return(  <div> 
        <p>{userdetail.title}</p>
        <p>{userdetail.company}</p>
        <p>{userdetail.location}</p>
        <p>{userdetail.from}</p><p>        </p><p>{userdetail.to}</p>
        <p>{userdetail.desc}</p>
        <p>{userdetail.industry}</p>
        </div>
      )
      })
      let education=this.state.userdata[0] && this.state.userdata[0].education.map(userdetail=>{ 
...
<h3>Summary</h3>
    <div>
    {this.state.userdata[0] ? this.state.userdata[0].profileSummary:""}
    </div>
    </section>
    <section class="pv-profile-section pv-top-card-section artdeco-container-card ember-view">
<h3>Skills</h3>
    <div>
    {this.state.userdata[0] ? this.state.userdata[0].skills:""}
    </div>
    </section>
            <section class="pv-profile-section pv-top-card-section artdeco-container-card ember-view">
            <h3>Experience</h3>
