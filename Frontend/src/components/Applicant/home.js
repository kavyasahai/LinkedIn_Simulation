...
<a data-control-name="topcard_view_all_connections" href="/search/results/people/?facetNetwork=%5B%22F%22%5D&amp;origin=MEMBER_PROFILE_CANNED_SEARCH" id="ember1126" class="pv-top-card-v2-section__link pv-top-card-v2-section__link--connections ember-view">        <span class="svg-icon-wrap"><span class="visually-hidden">See connections (152)</span><li-icon aria-hidden="true" type="people-icon" class="pv-top-card-v2-section__icon mh1"><svg viewBox="0 0 24 24" width="24px" height="24px" x="0" y="0" preserveAspectRatio="xMinYMin meet" class="artdeco-icon" focusable="false"><path d="M20.74,14.2L19,13.54V12.86l0.25-.41A5,5,0,0,0,20,9.82V9a3,3,0,0,0-6,0V9.82a5,5,0,0,0,.75,2.63L15,12.86v0.68l-1,.37a4,4,0,0,0-.58-0.28l-2.45-1V10.83A8,8,0,0,0,12,7V6A4,4,0,0,0,4,6V7a8,8,0,0,0,1,3.86v1.84l-2.45,1A4,4,0,0,0,0,17.35V20a1,1,0,0,0,1,1H22a1,1,0,0,0,1-1V17.47A3.5,3.5,0,0,0,20.74,14.2ZM16,8.75a1,1,0,0,1,2,0v1.44a3,3,0,0,1-.38,1.46l-0.33.6a0.25,0.25,0,0,1-.22.13H16.93a0.25,0.25,0,0,1-.22-0.13l-0.33-.6A3,3,0,0,1,16,10.19V8.75ZM6,5.85a2,2,0,0,1,4,0V7.28a6,6,0,0,1-.71,2.83L9,10.72a1,1,0,0,1-.88.53H7.92A1,1,0,0,1,7,10.72l-0.33-.61A6,6,0,0,1,6,7.28V5.85ZM14,19H2V17.25a2,2,0,0,1,1.26-1.86L7,13.92v-1a3,3,0,0,0,1,.18H8a3,3,0,0,0,1-.18v1l3.72,1.42A2,2,0,0,1,14,17.21V19Zm7,0H16V17.35a4,4,0,0,0-.55-2l1.05-.4V14.07a2,2,0,0,0,.4.05h0.2a2,2,0,0,0,.4-0.05v0.88l2.53,1a1.5,1.5,0,0,1,1,1.4V19Z" class="large-icon" style={{'fill':'currentColor'}}></path></svg></li-icon></span>
  ...
  <div id="ember1128" class="pv-top-card-section__summary ember-view">
    <div id="ember1129" class="pv-top-card-section__summary-treasury mt4 pv-treasury-list-preview ember-view"></div>
        ...
        <div id="summary" class="modal fade" role="dialog" show="this.state.summaryinserted" >
        <div class="modal-dialog">
          ...
          <div id="ember3742" class="ember-view"><div id="ember3743" class="ember-view"></div></div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" onClick = {this.submitSummary}>Save</button>
            </div>
          </div>
...
<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember1630-results" id="position-title-typeahead" placeholder="Ex: Manager" maxlength="100" type="text" />
</div>
...
<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember1635-results" id="position-company-typeahead" placeholder="Ex: Microsoft" maxlength="100" type="text" />
</div>
</div>
...
<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember1640-results" id="position-location-typeahead" placeholder="Ex: London, United Kingdom" maxlength="80" type="text" />
</div>

<div id="ember1642" class="ember-view"></div>
</div></div>

<div id="ember1643" class="pe-secondary-locale-tooltip-trigger ember-view">          <fieldset id="ember1644" class="pe-form-time-period pe-form-field ember-view"><div class="pe-form-time-period__container">
...
<select data-control-name="edit_position_start_date_month" name="startMonth" id="position-start-month" class="ember-view">  <option value="">Month</option>
...
<select data-control-name="edit_position_start_date_year" name="startYear" id="position-start-year" class="ember-view">  <option value="">Year</option>
...
<option value="1959">1959</option>
  ...
  <p class="pe-form-time-period__present-activity pt5 mt2">Present</p>
</div>

<div id="ember1797" class="ember-view"></div>

<div id="ember1798" class="pe-form-time-period__ongoing-activity mt4 ember-view"><input data-control-name="edit_position_date_toggle" tabindex="0" id="position-currently-works-here" class="ember-checkbox state-checkbox visually-hidden toggle-switch__input ember-view" type="checkbox" />
</div>
</fieldset>
...
<div class="pe-form-field">
  ...
  <select name="industry" id="position-industry" class="position-industry mt1 ember-view">  <option value="">Choose an industry…</option>
...
<div class="pe-form-field pe-position-form__headline-field floating-label  " data-form-elem-focus="true">

  <label for="position-headline" class="pe-form-field__label label-text required">
    Headline
  </label>

  <textarea name="headline" id="position-headline" class="pe-position-form__headline-text ember-text-area pe-form-field__textarea ember-view"></textarea>
...
<textarea name="description" id="position-description" class="ember-text-area pe-form-field__textarea ember-view"></textarea>
...
<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember2874-results" id="edu-school-typeahead" placeholder="Ex: Boston University" type="text" />
</div>
...
<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember2878-results" id="edu-degree-typeahead" placeholder="Ex: Bachelor’s" type="text" />
</div>
...
<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember2882-results" id="edu-field-of-study-typeahead" placeholder="Ex: Business" type="text" />
</div>
  ...
  <input name="grade" maxlength="80" id="edu-grade" class="ember-text-field pe-form-field__text-input ember-view" type="text" />
 ...
 <label for="edu-activities-societies" class="pe-form-field__label label-text">
  ...
  <textarea name="activities" id="edu-activities-societies" class="pe-education-form__activities-text ember-text-area pe-form-field__textarea ember-view"></textarea>
...
<select data-control-name="edit_education_start_year" name="startYear" id="pe-education-form__start-year" class="pe-education-form__start-year ember-view">  <option value="">Year</option>
...
<select data-control-name="edit_education_end_year" id="pe-education-form__end-year" class="pe-education-form__end-year ember-view">  <option value="">Year</option>
  ...
  <textarea name="description" id="edu-description" class="ember-text-area pe-form-field__textarea ember-view"></textarea>
   ...
   <div class="modal fade" id="skills" role="dialog">
    <div class="modal-dialog">
      ...
      <input aria-autocomplete="list" autocomplete="off" spellcheck="false" placeholder="Skill (ex: Data Analysis)" autocorrect="off" autocapitalize="off" id="a11y-ember3230" class="ember-text-field ember-view" role="combobox" aria-expanded="false"></input>
          </div>
...
const mapDispatchStateToProps = dispatch => {
    return {
      onSummaryHandle : (data) => {
          console.log(data);
          axios.post('http://localhost:3001/insertsummary', data)
              .then((response) => {
