...
class Homepage extends Component {
    ...
    const res = await axios
      ...
      .then(response => {
        ...
        this.setState({
          ...
          skills:response.data.updatedList.experience[0].skills,
          school:response.data.updatedList.experience[0].school,
          fieldofstudy:response.data.updatedList.experience[0].fieldofstudy,
          degree:response.data.updatedList.experience[0].degree,
          grade:response.data.updatedList.experience[0].grade
        });
      });
  ...
  editskills = e => {
    ...
    axios.post("http://localhost:3001/editskills", data)
      .then(response => {
        window.location.reload();
      });
  };
  ...
  editeducation = e => {
    ...
    axios.post("http://localhost:3001/editeducation", data)
      .then(response => {
        window.location.reload();
      });
  };
  ...
  render() {
    ...
    return (
      <div class="container">
        <Head />
        <div
          class="pv-content profile-view-grid neptune-grid two-column ghost-animate-in "
          ...
          <div style={{ height: "100%", width: "100%" }}>
            ...
            <div class="homesummary">
              ...
              <section class="pv-profile-section pv-top-card-section artdeco-container-card ember-view">
                <h3>Skills</h3>
                <div>
                <button class="skillsbutton" data-toggle="modal" data-target="#editskills">Edit</button>
                 <p> {this.state.userdata ? this.state.userdata.skills : ""}</p>
                </div>
              </section>
              <section class="pv-profile-section pv-top-card-section artdeco-container-card ember-view">
                <h3>Experience</h3>
              ...
              <div class="pe-s-form__body pe-form-body">
                  ...
                  <div class="pe-logo-container">
                    ...
                    <div id="ember2873" class="ember-view">
                      ...
                      <input
                        ...
                        id="edu-school-typeahead"
                        placeholder="Ex: Boston University"
                        type="text" value={this.state.school}
                        onChange={this.schoolChangeHandler}
                      />
                    </div>
                  </div>
                ...
                <div class="pe-form-field edu-degree-name">
                  <div id="ember2877" class="ember-view">
                    ...
                    <input
                      ...
                      id="edu-degree-typeahead"
                      placeholder="Ex: Bachelor’s"
                      type="text" value={this.state.degree}
                      onChange={this.degreeChangeHandler}
                    />
                  </div>
                ...
                <div class="pe-form-field edu-field-of-study">
                  <div id="ember2881" class="ember-view">
                    ...
                    <input
                      ...
                      id="edu-field-of-study-typeahead"
                      placeholder="Ex: Business"
                      type="text" value={this.state.fieldofstudy}
                      onChange={this.fieldofstudyChangeHandler}
                    />
                  </div>
                ...
                <div class="pe-form-field floating-label  ">
                  ...
                  <input
                    ...
                    id="edu-grade"
                    class="ember-text-field pe-form-field__text-input ember-view"
                    type="text" value={this.state.grade}
                    onChange={this.gradeChangeHandler}
                  />
                </div>
              ...
              <div class="modal-body">
                <div class="type-ahead-input">
                  ...
                  <input
                    ...
                    autocapitalize="off"
                    id="a11y-ember3230"
                    class="ember-text-field ember-view" value={this.state.skills?this.state.skills:""}
