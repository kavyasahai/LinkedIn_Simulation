...
class Homepage extends Component
{
    ...
    constructor(props)
    {
        ...
        this.jobstartmonthChangeHandler = this.jobstartmonthChangeHandler.bind(this);
        ...
        this.schoolfromyearChangeHandler = this.schoolfromyearChangeHandler.bind(this);
    ...
    async componentWillMount(){
      var headers = new Headers();
        ...
        const res=await axios.post('http://localhost:3001/getuserdata',data)
        .then((response) => {
...
jobdescChangeHandler  = (e) => {
  this.setState({
    ...
    submitSummary = (e) => {
        ...
        //prevent page from refresh
        e.preventDefault();
        const username="kesha3@gmail.com";
        const data = {
           username:username,
...
submitskills = (e) => {
  ...
  this.props.skillsinsert(data);
    ...
    render()
    {
      ...
      let experience=this.state.userdata[0] && this.state.userdata[0].experience.map(userdetail=>{ 
        ...
        return(  
                <div class="container">
                    ...
                    <Head></Head>  
                    <div class="pv-content profile-view-grid neptune-grid two-column ghost-animate-in " style={{"height":"100%","width":"100%"}}>
...
{this.state.userdata[0] ? this.state.userdata[0].firstname:""} has a  account
</span>
  ...
  <div>
    <h1 class="pv-top-card-section__name inline t-24 t-black">
      {this.state.userdata[0] ? this.state.userdata[0].firstname:""}
    </h1>
 </div>

    <h2 class="pv-top-card-section__headline  t-33 t-black">
      {this.state.userdata[0] ? this.state.userdata[0].education[0].degree:""} Student at {this.state.userdata[0] ? this.state.userdata[0].education[0].school:""}
    </h2>

  <h3 class="pv-top-card-section__location t-33 t-black--light  inline-block">
    {this.state.userdata[0] ? this.state.userdata[0].country:""}
  </h3>
<div class="profilesection">
  ...
  <div class="dropdown-content">
    <a data-toggle="modal" href="#myModal">Summary</a>
    <a data-toggle="modal" href="#experience">Work Experience</a>
    <a data-toggle="modal" href="#education">Education</a>
    <a data-toggle="modal" href="#skills">Skills</a>
    <a data-toggle="modal" href="#resume">Resume</a>
  </div>
</div>
...
<div class="pv-top-card-v2-section__links">
    ...
    <button href="#education-section" data-control-name="education_see_more" class="pv-top-card-v2-section__link pv-top-card-v2-section__link-education mb1" data-ember-action="" data-ember-action-1122="1122">
        <span id="ember1124" class="pv-top-card-v2-section__entity-name pv-top-card-v2-section__school-name text-align-left ml2 t-33 t-black t-bold lt-line-clamp lt-line-clamp--multi-line ember-view" style={{'-webkit-line-clamp': '2'}}> {this.state.userdata[0] ? this.state.userdata[0].education[0].school:""}
...
<a data-control-name="topcard_view_all_connections" href="/search/results/people/?facetNetwork=%5B%22F%22%5D&amp;origin=MEMBER_PROFILE_CANNED_SEARCH" id="ember1126" class="pv-top-card-v2-section__link pv-top-card-v2-section__link--connections ember-view">        <span class="svg-icon-wrap"><span class="visually-hidden">See connections (152)</span><li-icon aria-hidden="true" type="people-icon" class="pv-top-card-v2-section__icon mh1"><svg viewBox="0 0 24 24" width="24px" height="24px" x="0" y="0" preserveAspectRatio="xMinYMin meet" class="artdeco-icon" focusable="false"><path d="M20.74,14.2L19,13.54V12.86l0.25-.41A5,5,0,0,0,20,9.82V9a3,3,0,0,0-6,0V9.82a5,5,0,0,0,.75,2.63L15,12.86v0.68l-1,.37a4,4,0,0,0-.58-0.28l-2.45-1V10.83A8,8,0,0,0,12,7V6A4,4,0,0,0,4,6V7a8,8,0,0,0,1,3.86v1.84l-2.45,1A4,4,0,0,0,0,17.35V20a1,1,0,0,0,1,1H22a1,1,0,0,0,1-1V17.47A3.5,3.5,0,0,0,20.74,14.2ZM16,8.75a1,1,0,0,1,2,0v1.44a3,3,0,0,1-.38,1.46l-0.33.6a0.25,0.25,0,0,1-.22.13H16.93a0.25,0.25,0,0,1-.22-0.13l-0.33-.6A3,3,0,0,1,16,10.19V8.75ZM6,5.85a2,2,0,0,1,4,0V7.28a6,6,0,0,1-.71,2.83L9,10.72a1,1,0,0,1-.88.53H7.92A1,1,0,0,1,7,10.72l-0.33-.61A6,6,0,0,1,6,7.28V5.85ZM14,19H2V17.25a2,2,0,0,1,1.26-1.86L7,13.92v-1a3,3,0,0,0,1,.18H8a3,3,0,0,0,1-.18v1l3.72,1.42A2,2,0,0,1,14,17.21V19Zm7,0H16V17.35a4,4,0,0,0-.55-2l1.05-.4V14.07a2,2,0,0,0,.4.05h0.2a2,2,0,0,0,.4-0.05v0.88l2.53,1a1.5,1.5,0,0,1,1,1.4V19Z" class="large-icon" style={{'fill':'currentColor'}}></path></svg></li-icon></span>
  ...
  <div id="ember1128" class="pv-top-card-section__summary ember-view">
    <div id="ember1129" class="pv-top-card-section__summary-treasury mt4 pv-treasury-list-preview ember-view"></div>
        ...
        <div id="ember8838" class="pv-profile-info-section mb4 ember-view" style={{"margin-top":"-40vw"}}>
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
    ...
    <div id="ember1628" class="pe-form-field position-title floating-label ember-view"><div class="pe-form-field position-title  ">
  <div id="ember1629" class="ember-view">  <label for="position-title-typeahead" class="mb1 required">
  Title
</label>



<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember1630-results" id="position-title-typeahead" placeholder="Ex: Manager" maxlength="100" type="text" onChange={this.jobtitleChangeHandler} />
</div>

<div id="ember1632" class="ember-view"></div>
</div></div>


    <div id="ember1633" class="pe-form-field position-company-name has-logo floating-label ember-view">
...
<img class="lazy-image pe-logo-container__img ghost-company loaded" alt="" height="24" width="24" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" />
  ...
  <div id="ember1634" class="ember-view">  <label for="position-company-typeahead" class="mb1 required">
  Company
</label>


<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember1635-results" id="position-company-typeahead" placeholder="Ex: Microsoft" maxlength="100" type="text" onChange={this.jobcompanyChangeHandler} />
</div>
</div>

<div id="ember1637" class="ember-view"></div></div>

    <div id="ember1638" class="pe-form-field position-location-name floating-label ember-view"><div class="pe-form-field position-location-name  ">
  <div id="ember1639" class="ember-view">  <label for="position-location-typeahead" class="mb1 ">
  Location
</label>



<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember1640-results" id="position-location-typeahead" placeholder="Ex: London, United Kingdom" maxlength="80" type="text" onChange={this.joblocationChangeHandler} />
</div>

<div id="ember1642" class="ember-view"></div>
</div></div>

<div id="ember1643" class="pe-secondary-locale-tooltip-trigger ember-view">          
  <fieldset id="ember1644" class="pe-form-time-period pe-form-field ember-view">
    ...
    <div class="pe-form-time-period__date-field ">
      <div class="pe-form-time-period__date-unit">
        <label class="visually-hidden" for="position-start-month">
          Start month
       </label>
       <span id="ember1645" class="ember-view">
      <select data-control-name="edit_position_start_date_month" name="startMonth" id="position-start-month" class="ember-view" onChange={this.jobstartmonthChangeHandler}>  
...
<option value="12">December</option>
    ...
    <div class="pe-form-time-period__date-unit">
      <label class="visually-hidden" for="position-start-year">
        Start year
      </label>
      <span id="ember1659" class="ember-view">
<select data-control-name="edit_position_start_date_year" name="startYear" id="position-start-year" class="ember-view">  <option value="" onChange={this.jobstartyearChangeHandler}>Year</option>
...
<div id="ember1797" class="ember-view"></div>
  ...
  <fieldset id="ember1644" class="pe-form-time-period pe-form-field ember-view">
    ...
    <div class="pe-form-time-period__date-field ">
      <div class="pe-form-time-period__date-unit">
       ...
       <span id="ember1645" class="ember-view">
      <select data-control-name="edit_position_start_date_month" name="startMonth" id="position-start-month" class="ember-view" onChange={this.jobendmonthChangeHandler}>  
        <option value="">Month</option>
<option value="1">January</option>
<option value="2">February</option>
<option value="3">March</option>
...
<option value="12">December</option>
    ...
    <div class="pe-form-time-period__date-unit">
      ...
      <span id="ember1659" class="ember-view">
<select data-control-name="edit_position_start_date_year" name="startYear" id="position-start-year" class="ember-view">  <option value="" onChange={this.jobendyearChangeHandler}>Year</option>
...
<div class="pe-form-field">
  <label for="position-industry" class="pe-form-field__label required">
    Industry
  </label>

  <select name="industry" id="position-industry" class="position-industry mt1 ember-view">  <option value="" onChange={this.jobfieldChangeHandler}>Choose an industry…</option>
...
<option value="urn:li:fs_industry:103">Writing &amp; Editing</option>
        ...
        <div id="ember1969" class="ember-view"><div id="ember1970" class="pe-form-field mb3 ember-view"><input tabindex="0" id="position-update-headline-checkbox" class="ember-checkbox state-checkbox visually-hidden toggle-switch__input ember-view" type="checkbox" />
    ...
    <div id="ember1800" class="pe-form-field position-description floating-label ember-view"><label for="position-description" class="pe-form-field__label label-text">
Description
</label>

<textarea name="description" id="position-description" class="ember-text-area pe-form-field__textarea ember-view" onChange={this.jobdescChangeHandler}></textarea>

</div>
    <div id="ember1802" class="pe-form-field pe-treasury-view ember-view">

</div>
  </div>      
    </div>
    <div class="modal-footer">
      <button type="button" class="btn btn-primary" data-dismiss="modal" onClick = {this.submitExperience}>Save</button>
    </div>
  </div>
...
<div id="education" class="modal fade" role="dialog">
  ...
  <div class="pe-logo-container">
    <img class="lazy-image pe-logo-container__img ghost-school loaded" alt="" height="24" width="24" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" />
      ...
      <div id="ember2873" class="ember-view">  <label for="edu-school-typeahead" class="mb1 required">
    School
  </label>



<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember2874-results" id="edu-school-typeahead" placeholder="Ex: Boston University" type="text" onChange={this.schoolChangeHandler}/>
</div>

  </div>

  <div id="ember2876" class="ember-view"></div>
</div>


      <div class="pe-form-field edu-degree-name">
    <div id="ember2877" class="ember-view">  <label for="edu-degree-typeahead" class="mb1 ">
    Degree
  </label>



<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember2878-results" id="edu-degree-typeahead" placeholder="Ex: Bachelor’s" type="text" onChange={this.degreeChangeHandler} />
</div>


  <div id="ember2880" class="ember-view"></div>
</div>


      <div class="pe-form-field edu-field-of-study">
    <div id="ember2881" class="ember-view">  <label for="edu-field-of-study-typeahead" class="mb1 ">
    Field of study
  </label>



<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember2882-results" id="edu-field-of-study-typeahead" placeholder="Ex: Business" type="text" onChange={this.fieldofstudyChangeHandler}/>
</div>


  <div id="ember2884" class="ember-view"></div>
</div>
  ...
  <input name="grade" maxlength="80" id="edu-grade" class="ember-text-field pe-form-field__text-input ember-view" type="text" onChange={this.gradeChangeHandler}/>

</div>


      <div id="ember2887" class="pe-secondary-locale-tooltip-trigger ember-view">  
...
<select data-control-name="edit_education_start_year" name="startYear" id="pe-education-form__start-year" class="pe-education-form__start-year ember-view">  <option value="" onChange={this.schoolfromyearChangeHandler}>Year</option>
...
<select data-control-name="edit_education_end_year" id="pe-education-form__end-year" class="pe-education-form__end-year ember-view">  <option value="" onChange={this.schooltoyearChangeHandler}>Year</option>
  ...
  <option value="1900">1900</option>
    ...
    <div id="ember3137" class="ember-view"></div>
  </fieldset>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal" onClick={this.submitschool}>Save</button>
      </div>
    </div>
   ...
   <div class="modal fade" id="skills" role="dialog">
    <div class="modal-dialog">
      ...
      <input placeholder="Skill (ex: Data Analysis)" autocorrect="off" autocapitalize="off" id="a11y-ember3230" class="ember-text-field ember-view" onChange={this.skillsChangeHandler}></input>
          </div>

          
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" data-dismiss="modal" onClick={this.submitskills}>Add</button>
        </div>
      </div>
  ...
  <input class="ember-text-field ember-view" type="file" ></input>
      </div>
      </div>
      <div class="modal-footer">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="pe-s-multi-field">
          <div class="pe-top-card-form__name-field">
            <div class="pe-s-multi-field__item pe-form-field pe-top-card-form__first-name-field floating-label  " data-form-elem-focus="true">
              ...
              <input name="firstName" maxlength="20" id="topcard-firstname" class="ember-text-field pe-form-field__text-input ember-view" type="text" onChange={this.firstnameChangeHandler} />
            </div>
          </div>
          <div class="pe-top-card-form__name-field">
            <div class="pe-s-multi-field__item pe-form-field pe-top-card-form__last-name-field floating-label  " data-form-elem-focus="true">
              ...
              <input name="lastName" maxlength="40" id="topcard-lastname" class="ember-text-field pe-form-field__text-input ember-view" type="text" onChange={this.lastnameChangeHandler} />
            </div>
          </div>
        </div>
        ...
        <label for="topcard-headline" class="pe-form-field__label label-text required">
         ...
         <textarea name="headline" id="topcard-headline" class="pe-top-card-form__headline-text ember-text-area pe-form-field__textarea ember-view" onChange={this.headlineChangeHandler}></textarea>
       </div>  
       ...
       <div id="ember3333" class="pe-secondary-locale-tooltip-trigger ember-view">        <select data-control-name="location_country_chooser" name="locationCountry" id="location-country" class="ember-view" onChange={this.countryChangeHandler}>
         ...
         <div class="pe-s-multi-field__item pe-form-field floating-label zipcode-field
          ...
          <div id="ember3583" class="pe-secondary-locale-tooltip-trigger ember-view">          <div class="pe-location-picker__postal-code-input-container">
                    <input name="zipcode" maxlength="8" id="location-zipcode" class="pe-form-field__location-zipcode ember-text-field ember-view" type="text" onChange={this.zipcodeChangeHandler} />
                  </div>
          ...
          <input type="text" name="citystate" class="ember-view" onChange={this.locationChangeHandler} placeholder="Ex:San Jose, California" />
          ...
          <div id="ember3585" class="pe-secondary-locale-tooltip-trigger ember-view">      <select name="industry" id="topcard-industry" class="ember-view" onChange={this.industryChangeHandler}>  <option value="">Choose an industry…</option>
           ...
           <label for="topcard-summary" class="pe-form-field__label label-text">
            ...
            <textarea name="summary" id="topcard-summary" class="ember-text-area pe-form-field__textarea ember-view" onChange={this.summaryChangeHandler}></textarea>
