                        ...
                        <section class="onboarding-widget__single-card-container onboarding-profile-edit__container mhA">
                          ...
                          >
                            ...
                            <div id="ember491" class="ember-view">
                              <div
                                id="ember492"
                                class="mb2 onboarding-profile-edit__form-field onboarding-profile-form-field ember-view"
                              >
                                {" "}
                                <label
                                ...
                                <div
                                  id="ember493"
                                  class="onboarding-profile-typeahead onboarding-profile-typeahead__simple-view ember-view"
                                >
                                  ...
                                  <div
                                    ...
                                    aria-live="assertive"
                                    id="ember496"
                                    class="onboarding-profile-insight onboarding-profile-edit__jobs-title-insight-container ember-view"
                                  />
                                </div>
                                <div
                                  id="ember497"
                            ...
                            <div id="ember498" class="ember-view">
                              <div
                                id="ember499"
                                class="mt3 mb2 onboarding-profile-edit__form-field onboarding-profile-form-field ember-view"
                              >
                                {" "}
                                <label
                                  class="onboarding-profile-form-field__label t-14 t-black--light t-normal mt0 truncate onboarding-profile-form-field__label--required"
                                ...
                                <div
                                  id="ember500"
                                  class="onboarding-profile-typeahead onboarding-profile-typeahead__detailed-view ember-view"
                                >
                                  <input
                                    role="combobox"
                                    autocomplete="off"
                            ...
                            <footer class="mt5">
                              <button
                                data-control-name="profile_edit_is_student"
                                id="ember505"
                                class="onboarding-widget__cta button-tertiary-x-large full-width mb4 ember-view"
