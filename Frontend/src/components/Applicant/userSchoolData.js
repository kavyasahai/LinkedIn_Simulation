                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              <div
                                id="ember2487"
                                class="overflow-hidden focused-easeIn-motion onboarding-profile-edu__accordion--is-collapsed ember-view"
                              >
                                <label class="m0" for="add-edu-over-16">
                                  <div class="onboarding-profile-edu__form-field onboarding-profile-edu__over-16">
                                    ...
                                    <div class="onboarding-profile-edu__over-16-toggle-wrapper">
                                      <div
                                        id="ember2488"
                                        class="toggle-24dp ember-view"
                                      >
                                        <input
                                          data-control-name="profile_edu_is_over_16_toggle"
                                          tabindex="0"
                                          id="add-edu-over-16"
                                        ...
                                        >
                                          <p
                                            class="checked t-14 t-black--light t-normal"
                                            aria-hidden="true"
                                          >
                                            Yes
                                          </p>
                              ...
                              <div
                                id="ember2490"
                                class="overflow-hidden focused-easeInOut-motion onboarding-profile-edu__accordion--is-collapsed ember-view"
                              >
                                <section class="m0">
                                  <fieldset>
                                    <legend class="t-14 t-black t-bold pt4">
                                      Date of birth
                                    </legend>

                                    <div
                                      id="ember2492"
                                      class="onboarding-profile-edu__form-field-container ember-view"
                                    >
                                      <div
                                        id="ember2493"
                                        class="onboarding-profile-form-field onboarding-profile-date flex-grow-1 onboarding-profile-edu__form-field ember-view"
                                      >
                                        {" "}
                                        <label
                                          class="onboarding-profile-form-field__label t-14 t-black--light t-normal mt0 truncate onboarding-profile-form-field__label--required"
                                          for="onboarding-profile-edu-birthdate-month"
                                        >
                                          Month
                                        </label>
                                        <span id="ember2494" class="ember-view">
                                          <select
                                            data-control-name="profile_edu_birthdate_month"
                                            id="onboarding-profile-edu-birthdate-month"
                                            class="onboarding-input ember-view"
                                          >
                                            {" "}
                                            <option value="">-</option>
                                      ...
                                      >
                                        ...
                                        <label
                                          class="onboarding-profile-form-field__label t-14 t-black--light t-normal mt0 truncate onboarding-profile-form-field__label--required"
                                          for="onboarding-profile-edu-birthdate-day"
                                        >
                                          Day
                                        </label>
                                        <span id="ember2509" class="ember-view">
                                          <select
                                            data-control-name="profile_edu_birthdate_day"
                                            id="onboarding-profile-edu-birthdate-day"
                                            class="onboarding-input ember-view"
                                          >
                                            {" "}
                                            <option value="">-</option>
                                      ...
                                      >
                                        ...
                                        <label
                                          class="onboarding-profile-form-field__label t-14 t-black--light t-normal mt0 truncate onboarding-profile-form-field__label--required"
                                          for="onboarding-profile-edu-birthdate-year"
                                        >
                                          Year
                                        </label>
                                        <span id="ember2543" class="ember-view">
                                          <select
                                            data-control-name="profile_edu_birthdate_year"
                                            id="onboarding-profile-edu-birthdate-year"
                                            class="onboarding-input ember-view"
                                          >
                                            {" "}
                                            <option value="">-</option>
                                    ...
                                    <p
                                      class="onboarding-profile-edu__error
t-14 t-black t-bold
overflow-hidden
...
"
                                      aria-expanded="false"
                                    >
                                      We love having ambitious people like you
                                      on LinkedIn, but you’re currently under
                                      our age limit.
                                    </p>
                                  </fieldset>
                                </section>
                              ...
                              <footer class="mt5">
                                <button
                                  data-control-name="profile_edu_not_a_student"
                                  id="ember2606"
                                  class="onboarding-widget__cta onboarding-profile-cta button-tertiary-x-large full-width mb4 ember-view"
                                >
                                  {" "}
                                  I’m not a student
                                </button>
