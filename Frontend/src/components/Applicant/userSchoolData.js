...
<section id="ember2995" class="onboarding-profile-edu onboarding-widget__single-card-container mhA display-flex justify-center ember-view">
          <div id="ember2996" class="onboarding-profile-edu--has-min-width ember-view"><div id="ember2997" class="onboarding-profile-form full-width ember-view">  <div id="ember2998" class="ember-view"><div id="ember2999" class="mb2 onboarding-profile-edu__form-field onboarding-profile-form-field ember-view">  <label class="onboarding-profile-form-field__label t-14 t-black--light t-normal mt0 truncate onboarding-profile-form-field__label--required" for="typeahead-input-for-school-name">
    School or College/University
  </label>

  <div class="onboarding-profile-edu__school-name">
    <div id="ember3000" class="onboarding-profile-typeahead onboarding-form-field__typeahead onboarding-profile-typeahead__detailed-view ember-view"><artdeco-typeahead-deprecated id="ember3001" class="ember-view">

<artdeco-typeahead-deprecated-input id="ember3002" class="ember-view">
<input role="combobox" autocomplete="off" spellcheck="false" aria-autocomplete="list" aria-owns="ember3001-results" aria-expanded="false" id="typeahead-input-for-school-name" type="text" placeholder="Enter School" onChange={this.schoolChangeHandler} />
</artdeco-typeahead-deprecated-input>
</artdeco-typeahead-deprecated>

</div>
<div role="status" aria-live="assertive" id="ember3003" class="onboarding-profile-insight onboarding-profile-edu__school-insight-container display-flex ml4 ember-view"></div>  </div>


  <div id="ember3004" class="onboarding-profile-error-container ember-view"></div>
</div></div>
  ...
  <section>
    ...
    <div class="onboarding-profile-edu__form-field-container pt1">
      <div id="ember3005" class="mr5 onboarding-profile-edu__form-field onboarding-profile-edu__school-years-form-field flex-grow-1 ember-view"><div id="ember3006" class="onboarding-profile-form-field ember-view">  <label class="onboarding-profile-form-field__label t-14 t-black--light t-normal mt0 truncate onboarding-profile-form-field__label--required" for="onboarding-profile-edu-start-year">
    Start year
  </label>

  <span id="ember3007" class="ember-view">
<select data-control-name="profile_edu_start_year" id="onboarding-profile-edu-start-year" class="onboarding-input ember-view" placeholder="Start Year" onChange={this.startyearChangeHandler}>  <option value="Start Year" placeholder="Start Year">-</option>
  ...
  <option value="1959">1959</option>
      ...
      <div id="ember3069" class="onboarding-profile-edu__form-field onboarding-profile-edu__school-years-form-field flex-grow-1 ember-view"><div id="ember3070" class="onboarding-profile-form-field ember-view">
...
<select data-control-name="profile_edu_end_year" id="onboarding-profile-edu-end-year" class="onboarding-input ember-view">  <option value="End Year" placeholder="End Year" onChange={this.endyearChangeHandler}>-</option>
  ...
  <footer class="mt5">
    ...
    <button data-control-name="profile_edu_continue" disabled="" id="ember3254" class="onboarding-widget__cta onboarding-profile-cta button-primary-x-large full-width ember-view" onClick={this.submitSchool}>Continue</button>
  </footer>
</div></div>
</section>
